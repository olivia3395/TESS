...
"""
Dynamic Dropout MultiModal Baseline with Max Pooling (Hard Classification):
...
class MultiModal_Baseline_Dynamic_Dropout_MaxPool_Hard(nn.Module):
    def __init__(self, configs):
        super(MultiModal_Baseline_Dynamic_Dropout_MaxPool_Hard, self).__init__()
