...
class CaDisen_rebuttal(nn.Module):
    def __init__(self, configs):
        super(CaDisen_rebuttal, self).__init__()
    ...
    def forward(self,x_enc,meta_feat,news_feat,flag='train'):
        ...
        return x_enc,meta_embed,news_embed
    ...
    def get_granger_elements(self,batch_x,meta_domain,news,flag,batch_y):
        x,env_embed, news_embed = self.forward(batch_x,meta_domain,news,flag)  
        return {
            'X': x.detach(),
            'E': env_embed.detach(),
            'S': news_embed.detach(),
