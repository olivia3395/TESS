...
"""
计算 ver_8BInstruct_withfewshots 系列数据集的命中率
"""
...
def parse_news_to_steps(news_string):
    """
    将news字符串解析为step列表
    例如: "-12, -13, -14, -15, -11" -> [-12, -13, -14, -15, -11]
...
def main():
    ...
    # 定义需要比较的数据集组合（ver_8BInstruct_withfewshots系列）
    comparisons = [
        # (ground_truth_dataset, prediction_dataset, split, description)
        ("ver_synchronized", "ver_8BInstruct_withfewshots_trendstrength", "test", "ver_synchronized vs ver_8BInstruct_withfewshots_trendstrength"),
        ("ver_synchronized", "ver_8BInstruct_withfewshots_trendstrength", "vali", "ver_synchronized vs ver_8BInstruct_withfewshots_trendstrength"),
        ("ver_synchronized", "ver_8BInstruct_withfewshots_trendstrength", "train", "ver_synchronized vs ver_8BInstruct_withfewshots_trendstrength"),
        
        ("ver_synchronized_trendonly", "ver_8BInstruct_withfewshots_trendonly", "test", "ver_synchronized_trendonly vs ver_8BInstruct_withfewshots_trendonly"),
        ("ver_synchronized_trendonly", "ver_8BInstruct_withfewshots_trendonly", "vali", "ver_synchronized_trendonly vs ver_8BInstruct_withfewshots_trendonly"),
        ("ver_synchronized_trendonly", "ver_8BInstruct_withfewshots_trendonly", "train", "ver_synchronized_trendonly vs ver_8BInstruct_withfewshots_trendonly"),
    ]
    
    # Global-only 数据集使用不同的计算方法
    global_comparisons = [
        ("ver_synchronized_globalonly", "ver_8BInstruct_withfewshots_globalonly", "test", "ver_synchronized_globalonly vs ver_8BInstruct_withfewshots_globalonly"),
        ("ver_synchronized_globalonly", "ver_8BInstruct_withfewshots_globalonly", "vali", "ver_synchronized_globalonly vs ver_8BInstruct_withfewshots_globalonly"),
        ("ver_synchronized_globalonly", "ver_8BInstruct_withfewshots_globalonly", "train", "ver_synchronized_globalonly vs ver_8BInstruct_withfewshots_globalonly"),
    ]
    
    # Trendstrength 数据集列表
    trendstrength_datasets = [
        ("ver_synchronized", "ver_8BInstruct_withfewshots_trendstrength"),
    ]
    
    print("ver_8BInstruct_withfewshots系列数据集命中率计算结果:")
    print("=" * 80)
    ...
    # 保存结果到文件
    output_file = os.path.join(script_dir, "8BInstruct_withfewshots_hit_rate_results.json")
