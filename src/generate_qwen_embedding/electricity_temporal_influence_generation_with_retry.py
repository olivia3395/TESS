...
"""Generate temporal influence shape labels with retry and code extraction for Electricity dataset."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate temporal influence shape texts with retry for Electricity dataset"
    )
    parser.add_argument(
        "--data-path",
        type=str,
    ...
    parser.add_argument(
        "--output-path",
        type=str,
        default="/home/llh/MMTSF/MMTSF_LIB/dataset/Electricity/ver_temporal_shape",
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "You MUST output EXACTLY this single line with NO other text:\n"
            ...
            "- No calculations or reasoning\n"
            "- No additional text before or after the output line\n"
            "- Your ENTIRE response must be ONLY: Temporal Influence Shape: <label>\n\n"
            "INPUT DATA:\n"
            "Load: {{{historical_data}}} (48 steps, mean: {mean_value})\n"
            "News: {news}\n\n"
            "CLASSIFICATION RULES:\n"
            "1. Immediate: Deviation in steps 1-12, NOT 12+ consecutive → Immediate\n"
            "2. Sustained: 12+ CONSECUTIVE steps deviation → Sustained\n"
            "3. Delayed: No reaction in 1-12, reaction after step 12, NOT 12+ consecutive → Delayed\n\n"
            "OUTPUT NOW:\n"
            "Temporal Influence Shape: <Immediate or Delayed or Sustained>"
        ),
